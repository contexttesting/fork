...
| getArgs        | <em>function(this: *, !Array&lt;string&gt;, ...[Context](#type-context)): (!Array&lt;string&gt; \\| !Promise&lt;!Array&lt;string&gt;&gt;)</em> | The function to get arguments to pass the fork based on the parsed mask input and contexts.                                                                                                                      | -       |
| getOptions     | <em>function(this: *, ...[Context](#type-context)): [!child_process.ForkOptions](#type-child_processforkoptions)</em>                          | The function to get options for the fork, such as `ENV` and `cwd`, based on contexts.                                                                                                                            | -       |
